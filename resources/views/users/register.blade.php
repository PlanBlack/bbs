        ...
        <main class="flex-1">
          ...
          <span class="mr-2">
            ...
            注册
                        ...
                        <span class="text-base font-light">很高兴见到你！</span>
                    </div>
{!! Form::open(['url' => '/users/sign_up', 'method' => 'post', 'novalidate'=>'novalidate','accept-charset'=>"UTF-8", 'class'=>'simple_form new_user', 'id'=>'new_user' ]) !!}
                    @if($errors->any())
                    ...
                    @endif
                        <div class="p-5">
                            <div class="mb-5">
                                <input name="name" type="text" class="form-input w-full" placeholder="用户名" autocomplete="off">
                                <span class="block meta ml-3 mt-1 mb-3">允许中文、大小写英文、下划线</span>
                                <input name="email" type="email" class="form-input w-full mb-5" placeholder="Email">
                                <input name="password" type="password" class="form-input w-full" placeholder="密码">
                                <span class="block meta ml-3 mt-1 mb-3">六位以上</span>
                                <input name="password_confirmation" type="password" class="form-input w-full" placeholder="密码确认">
                            </div>
...
{{--                            </div>--}}
                            <div class="flex items-center">
                                <div class="flex-1">
                                    <button class="btn btn-big btn-blue py-2 block w-full text-center" type="submit">注册</button>
                                </div>
                                <div class="w-16 ml-3">
                                    <a class="btn btn-big btn-white block text-center" href="/users/sign_in">登录</a>
                                </div>
                            </div>
                        </div>
                    {!! Form::close() !!}
            ...
            <span class="px-2 bg-tertiary-99 sub">
              快速登录
                    ...
                    <div class="px-5 py-6 flex justify-around">
